...
<div class="container mt-3">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-right alert alert-primary ">  طلب كشف علامات ماجستير  </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('marks.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <label for="date" class="col-md-2 col-form-label text-md-right">  تاريخ التسجيل لاول مرة</label>
                        </div>
                      
                        <div class="form-group row">
                            
                            <div class="col-md-8 ml-4">
                                <input id="ststatus" type="text" class="form-control "
                                name="ststatus">
                                <div> {{$errors->first('ststatus')}} </div>
                            </div>
                            <label for="ststatus" class="col-md-2 col-form-label text-md-right">  حالة الطالب</label>
                        </div>

...
<div class="container mt-3">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-right alert alert-primary ">  طلب الحصول على حياة جامعية   </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('lifens.store') }}" enctype="multipart/form-data">
                        @csrf
